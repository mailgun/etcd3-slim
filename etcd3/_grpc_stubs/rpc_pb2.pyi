...
from etcd.api.mvccpb import kv_pb2 as _kv_pb2
from etcd.api.authpb import auth_pb2 as _auth_pb2
from etcd.api.versionpb import version_pb2 as _version_pb2
...
class StatusResponse(_message.Message):
    __slots__ = ["header", "version", "dbSize", "leader", "raftIndex", "raftTerm", "raftAppliedIndex", "errors", "dbSizeInUse", "isLearner", "storageVersion"]
    HEADER_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
